      ...
      {!session ? (
        <div className="flex flex-col justify-center items-center text-center p-10 bg-white rounded-lg shadow-xl max-w-md mx-auto -mt-24">
          ...
          <p className="mb-6 text-gray-600">
            Please sign in to access your personal profile and content.
          </p>
          <button
            onClick={() => signIn()}
                  ...
                  {following.length > 0 ? (
                    <div className="space-y-3">
                      {following.map((email, index) => (
                        <div
                          key={index}
                          className="flex items-center py-3 px-1 rounded-lg hover:bg-gray-50"
                        >
                          <div className="w-8  rounded-full bg-indigo-100 flex items-center justify-center text-indigo-500 font-medium mr-3">
